...
<b><i class="fa fa-volume-up"></i><font color="blue"> Bài Hát : Thê Tử 
</font></b></br>Nếu chưa có tên bài hát hãy vào chọn lại bài hát ở trên nhé các bạn!</br><audio loop="true" src="http://vietup.net/files/7911f0cf42371d380808dd1c815d1c00/b4f127891bfceb3344dd2b9435801202/Th%C3%AA%20T%E1%BB%AD%20L%E1%BA%A4Y%20S%E1%BB%90%20CHU%E1%BA%A8N%20T%E1%BA%A0I%20SX1368.COM.mp3" controls="controls" style="width:100%">  </audio></div>';}
...
mysql_query("UPDATE `users` SET $sql `total_on_site` = '$totalonsite', `lastdate` = " . time() . " WHERE `id` = '7'");echo'<div class="phdr"><i class="fa fa-line-chart"></i> Đang có '.($user_id || $set['active'] ? '<a href="/users/index.php?act=online"><font color="f8f8ff">'.$users.'' : $users).'</font></a> thành viên online và 917 khách online</div>';
